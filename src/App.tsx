gradient(135deg,${GOLDDIM},${GOLD})`,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontFamily:"'Cinzel',serif",fontSize:19,fontWeight:900,color:"#000",boxShadow:`0 0 18px ${GOLD}77`}}>G</div>
      </div>
    </header>
  );
}
        ...
        <div style={{padding:"20px 24px",flex:1}}>
          {step===1&&(
            <div>
              ...
              {label("INSTRUMENTS — pick all that apply")}{multi("instruments",INSTRUMENTS)}
          ...
          {step===3&&(
            <div>
              ...
              {label("VISUAL EFFECTS — pick all that apply")}{multi("effects",EFFECTS)}
              ...
              {label("EXTRAS — pick all that apply")}{multi("extras",EXTRAS)}
            </div>
          )}
          {step===4&&!result&&(
